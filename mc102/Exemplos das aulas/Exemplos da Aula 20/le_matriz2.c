/*
 * Le uma matriz de um arquivo. Os dois primeiros inteiros lidos sao
 * a dimensao da matriz. A matriz eh armazenada em varios vetores, cada
 * um para uma linha. 
 *
 * Escreve a matriz em um arquivo de saida segundo o formato:
 * linhas = 3
 * colunas = 3
 * mat[0][0] = 1.0
 * mat[0][1] = 2.4
