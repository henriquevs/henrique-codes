...
int main () {
    ...
    // Pula 50 linhas para que o jogador não saiba o número a ser adivinhado
    for(j = 0; j < 50; j++)
        printf("\n");
    
    // Sempre que o jogador der um palpite errado o jogo aguardará um novo palpite como entrada
    while(acertos != 5)
    {
        acertos = 0;  //zera para começar novo palpite
