/*  UNICAMP - Universidade Estadual de Campinas
    ...
    Laboratorio 07 - Agenda Telefonica 2 */
...
/* Funcao que busca telefones atraves de busca sequencial */
...
/* Funcao que remove um contato da agenda */
...
int main(){
   ...
   char nome_lido[TAM];
   bool ordenado = False; /* Inicialmente a agenda nao esta ordenada */
